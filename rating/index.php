        ...
        <div class="row justify-content-md-center">
            <div class="col-md-auto">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ms-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="../user/">Add Rating</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        <?php
                            $query_result = pg_query($db_handle, "SELECT *from user_rating");
                            ...
                            while ($row = pg_fetch_assoc($query_result)) {
                                ...
                                echo "<td>
                                    <a href='edit.php?id=".$row['rating_id']."'>Edit</a> /
                                   <a href='remove.php?id=".$row['rating_id']."'>Remove</a>
                                  </td>
                                </tr>";
                            }
                        ?>
